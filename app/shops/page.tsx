...
const shopData = [
  {
    id: "shop-1",
    name: "COMFORT Luxury Salon - South Extension",
    ...
    address: "A-23, Green Park Main, New Delhi, Delhi 110016",
    contactNumber: "+91 9876543210",
    email: "southextension@comfortsalon.com",
    workingHours: {
  ...
  {
    id: "shop-2",
    name: "COMFORT Luxury Salon - Connaught Place",
    image: "/assets/hero-bg.jpg",
    city: "New Delhi",
    state: "Delhi",
